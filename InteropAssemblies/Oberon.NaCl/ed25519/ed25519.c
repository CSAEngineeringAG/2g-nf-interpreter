...
static void get_hram(unsigned char *hram, const unsigned char *sm, const unsigned char *pk, unsigned char *playground, unsigned long smlen)
{
    unsigned int i;
    ...
    )
{
    ...
    *smlen = mlen+64;
    ...
    sc25519_to32bytes(sm + 32, &scs); /* cat s */
