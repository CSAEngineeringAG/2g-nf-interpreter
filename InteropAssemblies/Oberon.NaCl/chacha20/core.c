...
)
{
    ...
    j1 = x[1] = load_littleendian(c + 4);
    j2 = x[2] = load_littleendian(c + 8);
    j3 = x[3] = load_littleendian(c + 12);
    j4 = x[4] = load_littleendian(k + 0);
    j5 = x[5] = load_littleendian(k + 4);
    j6 = x[6] = load_littleendian(k + 8);
    j7 = x[7] = load_littleendian(k + 12);
    j8 = x[8] = load_littleendian(k + 16);
    j9 = x[9] = load_littleendian(k + 20);
    j10 = x[10] = load_littleendian(k + 24);
    j11 = x[11] = load_littleendian(k + 28);
    j12 = x[12] = load_littleendian(in + 8);
    j13 = x[13] = load_littleendian(in + 12);
    j14 = x[14] = load_littleendian(in + 0);
    j15 = x[15] = load_littleendian(in + 4);
