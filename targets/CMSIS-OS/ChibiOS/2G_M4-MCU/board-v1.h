...
/*
 * Porting for M4-MCUv1 15.10.2019 mku
 * STATUS: OK
 */
...
#define GPIOA_GPIO_74             	15U

#define GPIOB_PHY_RXD2              0U
#define GPIOB_PHY_RXD3              1U
#define GPIOB_BOOT1                 2U
#define GPIOB_GPIO_77               3U
#define GPIOB_GPIO_76               4U
#define GPIOB_GPIO_75				5U
#define GPIOB_FLASH_WAIT			6U
...
#define GPIOF_GPIO_51				8U
#define GPIOF_GPIO_52				9U
#define GPIOF_TP23					10U
#define GPIOF_TP20            		11U
...
#define GPIOH_GPIO_72_CAN1TX        13U
...
#define GPIOI_GPIO_73_CAN1RX        9U
...
#define LINE_GPIO_71               	PAL_LINE(GPIOA, 6U)
...
#define LINE_GPIO_74              	PAL_LINE(GPIOA, 15U)

#define LINE_PHY_RXD2               PAL_LINE(GPIOB, 0U)
#define LINE_PHY_RXD3               PAL_LINE(GPIOB, 1U)
#define LINE_BOOT1                  PAL_LINE(GPIOB, 2U)
#define LINE_GPIO_77				PAL_LINE(GPIOB, 3U)
#define LINE_GPIO_76				PAL_LINE(GPIOB, 4U)
#define LINE_GPIO_75				PAL_LINE(GPIOB, 5U)
#define LINE_FLASH_WAIT				PAL_LINE(GPIOB, 6U)
...
#define LINE_GPIO_51				PAL_LINE(GPIOF, 8U)
#define LINE_GPIO_52				PAL_LINE(GPIOF, 9U)
#define LINE_TP23					PAL_LINE(GPIOF, 10U)
#define LINE_TP20             		PAL_LINE(GPIOF, 11U)
...
#define LINE_PHY_INTR             	PAL_LINE(GPIOG, 15U)
 ...
 * PA2  - PHY_MDIO					(alternate 11 pullup).
 * PA3  - PHY_COL                   (alternate 11).
 * PA4  - PIN4						(input pullup).
 * PA5  - PIN5                      (input pullup).
 * PA6  - GPIO_71					(input pullup).
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PHY_CRS) |        \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_GPIO_71) |		\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_GPIO_74))
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_LOW(GPIOA_PHY_CRS) |			\
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOA_GPIO_71) |		\
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_PHY_CRS) |        \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOA_GPIO_74))
 ...
 * PB3  - GPIO_77                   (input pullup).
 * PB4  - GPIO_76                   (input pullup).
 * PB5  - GPIO_75					(input pullup).
 * PB6  - FLASH_WAIT				(input floating).
 * PB7  - FMC_NL                  	(output --> low).
...
#define VAL_GPIOB_MODER             (PIN_MODE_ALTERNATE(GPIOB_PHY_RXD2) |   \
                                     ...
                                     PIN_MODE_INPUT(GPIOB_GPIO_77) |		\
                                     PIN_MODE_INPUT(GPIOB_GPIO_76) |        \
                                     PIN_MODE_INPUT(GPIOB_GPIO_75) |		\
                                     PIN_MODE_INPUT(GPIOB_FLASH_WAIT) |		\
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PHY_RXD2) |   \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_GPIO_77) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOB_GPIO_76) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOB_GPIO_75) |	\
                                     PIN_OTYPE_PUSHPULL(GPIOB_FLASH_WAIT) | \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_PHY_RXD2) |		\
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOB_GPIO_77) |    \
                                     PIN_OSPEED_VERYLOW(GPIOB_GPIO_76) |    \
                                     PIN_OSPEED_VERYLOW(GPIOB_GPIO_75) |	\
                                     PIN_OSPEED_HIGH(GPIOB_FLASH_WAIT) |	\
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_PHY_RXD2) |   \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_GPIO_77) |		\
                                     PIN_PUPDR_PULLUP(GPIOB_GPIO_76) |      \
                                     PIN_PUPDR_PULLUP(GPIOB_GPIO_75) |		\
                                     PIN_PUPDR_FLOATING(GPIOB_FLASH_WAIT) |	\
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_PHY_RXD2) |			\
                                     ...
                                     PIN_ODR_HIGH(GPIOB_GPIO_77) |			\
                                     PIN_ODR_HIGH(GPIOB_GPIO_76) |			\
                                     PIN_ODR_HIGH(GPIOB_GPIO_75) |			\
                                     PIN_ODR_HIGH(GPIOB_FLASH_WAIT) |		\
                                     PIN_ODR_HIGH(GPIOB_FMC_NL) |         	\
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_PHY_RXD2, 11U) |     \
                                     ...
                                     PIN_AFIO_AF(GPIOB_GPIO_77, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_GPIO_76, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_GPIO_75, 0U) |		\
                                     PIN_AFIO_AF(GPIOB_FLASH_WAIT, 0U) |	\
                                     PIN_AFIO_AF(GPIOB_FMC_NL, 12U))
...
#define	VAL_GPIOB_BSRRH				(0x0080) //0x0080
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_PIN0) |  		\
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOC_SD_CARD_DT) |   \
...
#define	VAL_GPIOD_BSRRH				(0x0008) //0x0008
 ...
 * PF8  - GPIO_51					(input pullup).
 * PF9  - GPIO_52					(input pullup).
 * PF10 - TP23						(input pullup).
 * PF11 - TP20                		(input pullup).
...
#define VAL_GPIOF_MODER             (PIN_MODE_ALTERNATE(GPIOF_FMC_A0) |		\
                                     ...
                                     PIN_MODE_INPUT(GPIOF_GPIO_51) |		\
                                     PIN_MODE_INPUT(GPIOF_GPIO_52) |		\
                                     PIN_MODE_INPUT(GPIOF_TP23) |			\
                                     PIN_MODE_INPUT(GPIOF_TP20) | 			\
...
#define VAL_GPIOF_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOF_FMC_A0) |		\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOF_GPIO_51) |	\
                                     PIN_OTYPE_PUSHPULL(GPIOF_GPIO_52) |	\
                                     PIN_OTYPE_PUSHPULL(GPIOF_TP23) |		\
                                     PIN_OTYPE_PUSHPULL(GPIOF_TP20) | 		\
...
#define VAL_GPIOF_OSPEEDR           (PIN_OSPEED_HIGH(GPIOF_FMC_A0) |		\
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOF_GPIO_51) |	\
                                     PIN_OSPEED_VERYLOW(GPIOF_GPIO_52) |	\
                                     PIN_OSPEED_VERYLOW(GPIOF_TP23) |		\
                                     PIN_OSPEED_VERYLOW(GPIOF_TP20) |		\
...
#define VAL_GPIOF_PUPDR             (PIN_PUPDR_FLOATING(GPIOF_FMC_A0) |		\
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOF_GPIO_51) |		\
                                     PIN_PUPDR_PULLUP(GPIOF_GPIO_52) |		\
                                     PIN_PUPDR_PULLUP(GPIOF_TP23) |			\
                                     PIN_PUPDR_PULLUP(GPIOF_TP20) | 		\
...
#define VAL_GPIOF_ODR               (PIN_ODR_HIGH(GPIOF_FMC_A0) |			\
                                     ...
                                     PIN_ODR_HIGH(GPIOF_GPIO_51) |			\
                                     PIN_ODR_HIGH(GPIOF_GPIO_52) |			\
                                     PIN_ODR_HIGH(GPIOF_TP23) |				\
                                     PIN_ODR_HIGH(GPIOF_TP20) |				\
...
#define VAL_GPIOF_AFRH              (PIN_AFIO_AF(GPIOF_GPIO_51, 0U) |		\
                                     PIN_AFIO_AF(GPIOF_GPIO_52, 0U) |		\
                                     PIN_AFIO_AF(GPIOF_TP23, 0U) |			\
                                     PIN_AFIO_AF(GPIOF_TP20, 0U) |   		\
 ...
 * PG10 - FLASH_WP					(output floating --> high).
 * PG11 - RAM_CRE					(output floating --> low).
 * PG12 - TP21						(input pullup).
 * PG13 - FMC_A24					(alternate 12).
 * PG14 - PHY_TXD1                  (alternate 11).
 * PG15 - PHY_INTR                	(input floating).
 */
...
#define VAL_GPIOG_AFRH              (PIN_AFIO_AF(GPIOG_PIN8, 0U) |    		\
                                     ...
                                     PIN_AFIO_AF(GPIOG_FLASH_WP, 12U) |     \
                                     PIN_AFIO_AF(GPIOG_RAM_CRE, 12U) |		\
                                     PIN_AFIO_AF(GPIOG_TP21, 0U) |			\
                                     PIN_AFIO_AF(GPIOG_FMC_A24, 12U) |		\
                                     PIN_AFIO_AF(GPIOG_PHY_TXD1, 11U) |     \
                                     PIN_AFIO_AF(GPIOG_PHY_INTR, 0U))
#define VAL_GPIOG_BSRRH				(0x0800)
 ...
 * PH13 - GPIO_72_CAN1TX            (alternate 9).
...
#define VAL_GPIOH_MODER             (PIN_MODE_INPUT(GPIOH_OSC_IN) |					\
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOH_GPIO_72_CAN1TX) |		\
...
#define VAL_GPIOH_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOH_OSC_IN) |				\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOH_GPIO_72_CAN1TX) |		\
...
#define VAL_GPIOH_OSPEEDR           (PIN_OSPEED_HIGH(GPIOH_OSC_IN) |				\
                                     ...
                                     PIN_OSPEED_HIGH(GPIOH_GPIO_72_CAN1TX) |		\
...
#define VAL_GPIOH_PUPDR             (PIN_PUPDR_FLOATING(GPIOH_OSC_IN) |				\
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOH_GPIO_72_CAN1TX) |		\
...
#define VAL_GPIOH_ODR               (PIN_ODR_HIGH(GPIOH_OSC_IN) |					\
                                     ...
                                     PIN_ODR_HIGH(GPIOH_GPIO_72_CAN1TX) |			\
...
#define VAL_GPIOH_AFRH              (PIN_AFIO_AF(GPIOH_PIN8, 0U) |					\
                                     ...
                                     PIN_AFIO_AF(GPIOH_GPIO_72_CAN1TX, 9U) |		\
 ...
 * PI9  - GPIO_73_CAN1RX            (alternate 9 pullup).
...
#define VAL_GPIOI_MODER             (PIN_MODE_INPUT(GPIOI_PWR_STAT) |			\
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOI_GPIO_73_CAN1RX) | \
...
#define VAL_GPIOI_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOI_PWR_STAT) |   	\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOI_GPIO_73_CAN1RX) | \
...
#define VAL_GPIOI_OSPEEDR           (PIN_OSPEED_LOW(GPIOI_PWR_STAT) |       	\
                                     ...
                                     PIN_OSPEED_HIGH(GPIOI_GPIO_73_CAN1RX) |    \
...
#define VAL_GPIOI_PUPDR             (PIN_PUPDR_FLOATING(GPIOI_PWR_STAT) |   	\
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOI_GPIO_73_CAN1RX) |   \
...
#define VAL_GPIOI_ODR               (PIN_ODR_HIGH(GPIOI_PWR_STAT) |         	\
                                     ...
                                     PIN_ODR_HIGH(GPIOI_GPIO_73_CAN1RX) |       \
...
#define VAL_GPIOI_AFRH              (PIN_AFIO_AF(GPIOI_PIN8, 0U) |          	\
                                     PIN_AFIO_AF(GPIOI_GPIO_73_CAN1RX, 9U) |    \
