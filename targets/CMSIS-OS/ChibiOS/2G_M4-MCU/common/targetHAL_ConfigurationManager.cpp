...
bool InitialiseNetworkDefaultConfig(HAL_Configuration_NetworkInterface * pconfig, uint32_t configurationIndex)
{
	...
	//pconfig->IPv4Address = (uint32_t)0xc0a80165; 		//192.168.1.101
	// pconfig->IPv4NetMask = (uint32_t)0xffffff00;		//255.255.255.0
	// pconfig->IPv4GatewayAddress = (uint32_t)0xc0a00101;	//192.168.1.1
